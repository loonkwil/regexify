  ...
  return (
    <nav>
      <A
        href="/"
        title="Home (Ctrl + M)"
        aria-label="Click here to close the Cheat Sheet and go back to the home page"
  ...
  return (
    <>
      ...
      <dl>
        ...
        <dd>
          Negative lookahead assertion: Matches "x" only if "x" is not followed
          by "y".
        </dd>
        ...
        <dd>
          Negative lookbehind assertion: Matches "x" only if "x" is not preceded
          by "y".
        </dd>
      </dl>
      ...
      <dl>
        ...
        <dd>
          The <code>?</code> character after the quantifier makes the quantifier
          "non-greedy": meaning that it will stop as soon as it finds a match.
        </dd>
      </dl>
      <p>
        Source:{" "}
...
export default () => {
  ...
  return (
    <div class={styles.root}>
      <Title>Cheat Sheet - Regexify</Title>

      <Navigation />
      <main aria-label="Cheat Sheet">
        <Content />
      </main>
    </div>
  );
